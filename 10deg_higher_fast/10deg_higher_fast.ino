...
/*
  ...
  for (int s = 0; s < 3500; s++) {//Pitch down 10 deg
...
void loop() {
  ...
  for (int s = 0; s < 1500; s++) {//Roll left 10 deg - part a
  ...
  for (int s = 0; s < 2500; s++) {//Roll left 10 deg - part b
    digitalWrite(dirPin1, LOW); //Rod 1 up
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin1, LOW);
  ...
  for (int s = 0; s < 2000; s++) {//Pitch up 10 deg - part a
  ...
  for (int s = 0; s < 1500; s++) { //Pitch up 10 deg - part b
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
  ...
  for (int s = 0; s < 2000; s++) {//Roll right 10 deg - part b
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin1, LOW);
  ...
  for (int s = 0; s < 1500; s++) {// Return to Pitch down 10 deg - part a
  ...
  for (int s = 0; s < 2500; s++) {// Return to Pitch down 10 deg - part b
    digitalWrite(dirPin2, HIGH); //Rod 2 down
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
