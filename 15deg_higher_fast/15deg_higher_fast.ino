...
void setup() {
  ...
  for (int s = 0; s < 5000; s++) {//Pitch down 15 deg
...
void loop() {
  ...
  for (int s = 0; s < 2500; s++) {//Roll left 15 deg - part a
  ...
  for (int s = 0; s < 3000; s++) {//Roll left 15 deg - part b
    digitalWrite(dirPin1, LOW); //Rod 1 up
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin1, LOW);
  ...
  for (int s = 0; s < 2500; s++) {//Pitch up 5 deg - part c
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
  ...
  for (int s = 0; s < 1000; s++) {//Roll right 5 deg - part a
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin1, HIGH);
  ...
  for (int s = 0; s < 2000; s++) {//Return to Pitch down 15 deg - part a
  ...
  for (int s = 0; s < 4000; s++) {//Return to Pitch down 15 deg - part b
    digitalWrite(dirPin2, HIGH); //Rod 2 down
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
