...
void setup() {
  ...
  for (int s = 0; s < 250; s++) {//Pitch down 15 deg - 1
  ...
  for (int s = 0; s < 4500; s++) {//Pitch down 15 deg - 2
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin3, HIGH);
  ...
  for (int s = 0; s < 250; s++) {//Pitch down 15 deg - 3
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin3, HIGH);
    delayMicroseconds(wait2); // set rotate speed
    digitalWrite(pulPin3, LOW); // Output low
...
void loop() {
  ...
  for (int s = 0; s < 250; s++) {//Roll left 15 deg - part a1
  ...
  for (int s = 0; s < 2500; s++) {//Roll left 15 deg - part a2
    digitalWrite(dirPin1, LOW); //Rod 1 up
    digitalWrite(dirPin3, HIGH); //Rod 3 down
    digitalWrite(pulPin1, HIGH);
    digitalWrite(pulPin3, HIGH);
  ...
  for (int s = 0; s < 2750; s++) {//Roll left 15 deg - part b1
    digitalWrite(dirPin1, LOW); //Rod 1 up
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin1, LOW);
    ...
    for (int s = 0; s < 250; s++) {//Roll left 15 deg - part b2
    digitalWrite(dirPin1, LOW); //Rod 1 up
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait2);
    digitalWrite(pulPin1, LOW);
  ...
  for (int s = 0; s < 500; s++) {//Pitch up 15 deg - part a
  ...
  for (int s = 0; s < 2000; s++) { //Pitch up 15 deg - part b
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(dirPin3, HIGH); //Rod 3 down
    digitalWrite(pulPin2, HIGH);
    digitalWrite(pulPin3, HIGH);
  ...
  for (int s = 0; s < 2250; s++) {//Pitch up 5 deg - part c1
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
    ...
    for (int s = 0; s < 250; s++) {//Pitch up 5 deg - part c2
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait2);
    digitalWrite(pulPin2, LOW);
  ...
  for (int s = 0; s < 250; s++) {//Roll right 5 deg - part a1
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin1, HIGH);
    ...
    for (int s = 0; s < 750; s++) {//Roll right 5 deg - part a2
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(dirPin2, LOW); //Rod 2 up
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin1, HIGH);
  ...
  for (int s = 0; s < 2000; s++) {//Roll right 5 deg - part b
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin1, HIGH);
    digitalWrite(pulPin3, HIGH);
  ...
  for (int s = 0; s < 1750; s++) {//Roll right 5 deg - part b1
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin1, LOW);
    ...
    for (int s = 0; s < 250; s++) {//Roll right 5 deg - part b2
    digitalWrite(dirPin1, HIGH); //Rod 1 down
    digitalWrite(pulPin1, HIGH);
    delayMicroseconds(wait2);
    digitalWrite(pulPin1, LOW);
  ...
  for (int s = 0; s < 250; s++) {//Return to Pitch down 15 deg - part a1
    ...
    for (int s = 0; s < 1750; s++) {//Return to Pitch down 15 deg - part a2
    digitalWrite(dirPin2, HIGH); //Rod 2 down
    digitalWrite(dirPin3, LOW); //Rod 3 up
    digitalWrite(pulPin2, HIGH);
    digitalWrite(pulPin3, HIGH);
  ...
  for (int s = 0; s < 3750; s++) {//Return to Pitch down 15 deg - part b1
    digitalWrite(dirPin2, HIGH); //Rod 2 down
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait);
    digitalWrite(pulPin2, LOW);
    ...
    for (int s = 0; s < 250; s++) {//Return to Pitch down 15 deg - part b2
    digitalWrite(dirPin2, HIGH); //Rod 2 down
    digitalWrite(pulPin2, HIGH);
    delayMicroseconds(wait2);
    digitalWrite(pulPin2, LOW);
